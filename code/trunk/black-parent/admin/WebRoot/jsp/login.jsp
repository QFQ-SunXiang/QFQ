									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tbody>
											...
											<tr>
												...
												<td class="td_other">
													<input type="input" id="userName" name="userName" maxlength="20" class="input" value="admin" />
												</td>
											</tr>
											<tr>
												<td class="td_admin">密码：</td>
												<td class="td_other">
													<input type="password" id="password" name="password" maxlength="20" class="input" value="123456" />
												</td>
											</tr>
											<tr>
