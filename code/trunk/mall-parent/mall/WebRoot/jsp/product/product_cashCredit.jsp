    ...
    <div class="product-info left">
        ...
        <div class="product_item2 product-choose">
           <dl class="product-price clearfix">
               <dt class="font4">贷款金额</dt>
               <dd>
                   <span class="font-red font-size5">￥<strong><s:property value="%{formatDouble(productQuery.salePrice)}" /></strong></span>
               </dd>
           </dl>
       	</div>		
        <div class="product_item product-amount ">
             <dl class="product-amo clearfix">
                 <dd class=" dib-wrap">
                     	...
                     	<input id="quantity" class="event-item-quantity" value="1" type="hidden" />
			...
			<dl class="product-payment event-choose-month clearfix">
           		...
           		<dd style="padding-right:50px;">
               		<input type="hidden"  style="width:80px; height:25px; padding-left: 3px;" id="firstPay" onblur="cacuMonthPay()" value="0"/>
               	</dd>
                 <dt class="payment_2">贷款时间：</dt>
                 <dd>
                 ...
                 <dd id="instals" style="margin-left:20px;">
                    ...
                    <a href="javascript:;" class="inline-block font3 current" data-month="12">12个月</a>
                 </dd>
             </dl>
