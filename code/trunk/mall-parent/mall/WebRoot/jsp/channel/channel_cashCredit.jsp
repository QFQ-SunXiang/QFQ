...
<head>
	...
	<link rel="stylesheet" href="<%=basePath%>/../css/free.css" />
	<title>亲分期 - 亲白条专区</title>
</head>
<body>
	<div class="head">
	...
	<div class="w-container"><!--banner-->	     
		<div class="w-banner">
    		<div class="w-banner-img"><img src="mall/images/freeproduct/secondbanner.png" alt="背景"></div>
    	</div>
    	<div class="w-main">     
    	<!-- 内容 -->		     
        	<div class="mainwrap">
    	...
    	<div class="w-banner-down">
    		<div class="w-banner-img"><img src="mall/images/freeproduct/secondrule.png" alt="背景"></div>
    	</div>
	</div>
<!--底部-->
<footer>
